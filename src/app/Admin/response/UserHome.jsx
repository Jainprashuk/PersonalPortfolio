...
const UserHome = () => {
  ...
  useEffect(() => {
    axios
      .get("https://portfolio-backend-two-zeta.vercel.app/getdata")
      .then((response) => {
  ...
  return (
    <>
      {verified ? (
        ...
        <div>
          <section class="dark:bg-gray-50 bg-gray-900 min-h-screen my-auto">
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
              <div className="my-5">
                <h1 className="text-center text-5xl dark:text-gray-900 text-gray-400">
                  Admin Panel
                </h1>
                <p className="text-center dark:text-gray-900 text-gray-400">
                  (Only For Admins)
                </p>
              </div>
